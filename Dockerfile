...
RUN apt-get install php7.1 php7.1-cli php7.1-xml php7.1-curl php7.1-common php7.1-json php7.1-opcache php7.1-mysql php7.1-mbstring php7.1-mcrypt php7.1-zip php7.1-fpm apt-get install php7.1-gd -y
